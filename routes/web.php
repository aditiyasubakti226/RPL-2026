...
Route::put('/editorial/desk/submission/{submission}/update-round', [\App\Http\Controllers\Editorial\DeskController::class, 'updateRound'])->name('editorial.desk.update-round');